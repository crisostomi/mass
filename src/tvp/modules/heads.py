...
from tvp.data.datasets.templates import get_dataset_to_label, get_templates, dataset_descriptions, DATASET_TO_LABEL
from tvp.modules.encoder import ClassificationHead, ImageEncoder

pylogger = logging.getLogger(__name__)


def build_task_classification_head(model, task_names, data_location, cache_dir, openclip_cachedir, device):
