...
from tvp.task_vectors.aggregator import WeightedAggregator
from tvp.utils.routing_methods import compute_residual_norm
...
class AbstractRouter(torch.nn.Module, abc.ABC):
    ...
    def _logits_to_coefficients(self, norms) -> torch.Tensor:
        ...
        if self.routing_mode == "top1":
            ...
            tv_coefficients = torch.nn.functional.softmax(standardized_norms / self.temperature, dim=1)
