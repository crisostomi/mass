...
class MassAlgorithm:
    ...
    def __init__(
        ...
        self.model = MassInferenceWrapper(
            ...
            svd_dicts=self.svd_dict if isinstance(self.base_merger, TaskSingularVectorsMerger) or isinstance(self.base_merger, TaskSingularVectorsMergerNoRedundancy) else None,
            task_dicts=self.task_dicts if isinstance(self.base_merger, TaskArithmeticMerger) or isinstance(self.base_merger, DummyMerger) else None,
            merger=self.merger,
        ).to(device)
