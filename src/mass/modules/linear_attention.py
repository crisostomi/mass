...
class LinearMultiheadAttention(nn.Module):
    ...
    def __init__(self, module: nn.MultiheadAttention) -> None:
        super().__init__()
        self.construct_from_torch_attn(module)

    def construct_from_torch_attn(self, module: nn.MultiheadAttention):
        self.embed_dim = module.embed_dim
        self.num_heads = module.num_heads
        self.dropout = module.dropout
        self.add_bias_kv = module.bias_k is not None
        self.add_zero_attn = module.add_zero_attn

        self._qkv_same_embed_dim = module._qkv_same_embed_dim
        if not self._qkv_same_embed_dim:
            raise NotImplementedError("Not implemented for different qkv embed dim")

        self.kdim = module.kdim
        self.vdim = module.vdim
        ...
        q_weight, k_weight, v_weight = module.in_proj_weight.chunk(3)
        ...
        (
            self.in_proj_q.weight.data,
            self.in_proj_k.weight.data,
            self.in_proj_v.weight.data,
        ) = (
            q_weight,
            k_weight,
            v_weight,
        ...
        if q_bias is not None:
            (
                self.in_proj_q.bias.data,
                self.in_proj_k.bias.data,
                self.in_proj_v.bias.data,
            ) = (
                q_bias,
                k_bias,
                v_bias,
        ...
        if self.add_bias_kv:
            self.bias_k, self.bias_v = module.bias_k, module.bias_v
        else:
